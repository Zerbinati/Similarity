...
Value Eval::evaluate(const Position& pos, bool bestValue, Value rootEval, int* complexity) {
  ...
  v += rootEval != VALUE_NONE ? (std::clamp(rootEval, (Value)-100, (Value)100) / 50 * pos.count<ALL_PIECES>()) * (pos.side_to_move() * -2 + 1)  : 0;
