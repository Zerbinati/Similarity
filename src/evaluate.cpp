...
Value Eval::evaluate(const Position& pos, int* complexity, bool null) {
  ...
  bool useNull = useNNUE && null;
  if (useNull) useClassical = false;

  if ((!useNNUE  || !pos.this_thread()->switchToNNUE || useClassical) && !useNull)
  {
